...
class Evaluator:
    ...
    def _prettify(self, text: str):
        text = text.replace('_start_', '').replace('_classify_', '').replace(str(self._text_encoder._unk_token), '').replace('⁇', '')
        text = text.replace(str(self._text_encoder._cls_token), '').replace(str(self._text_encoder._sep_token), '').replace(str(self._text_encoder._pad_token), '')
        return text
