...
class BaseInputReader(ABC):
    ...
    def relation_type_count(self):
        print('relation_type_count: {}'.format(len(self._relation_types)))
        return len(self._relation_types)

    @property
    def entity_type_count(self):
        print('entity_type_count: {}'.format(len(self._entity_types)))
...
def _parse_tokens(jtokens, dataset, tokenizer):
    ...
    doc_encoding = [tokenizer.convert_tokens_to_ids(str(tokenizer._cls_token))]
    ...
    doc_encoding += [tokenizer.convert_tokens_to_ids(str(tokenizer._sep_token))]
